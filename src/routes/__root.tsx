...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Liu's Sweet Delights is a responsive website for ordering artisanal cakes and pastries for local delivery or pickup." },
      { property: "og:description", content: "Liu's Sweet Delights is a responsive website for ordering artisanal cakes and pastries for local delivery or pickup." },
      { name: "twitter:description", content: "Liu's Sweet Delights is a responsive website for ordering artisanal cakes and pastries for local delivery or pickup." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/696ec005-bc45-40cd-a71f-e2f062076d42/id-preview-551de457--b6d7a215-1816-4544-8798-68336faa67b3.lovable.app-1781136204160.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/696ec005-bc45-40cd-a71f-e2f062076d42/id-preview-551de457--b6d7a215-1816-4544-8798-68336faa67b3.lovable.app-1781136204160.png" },
    ],
    links: [
